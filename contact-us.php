...
.submit_button{background:#aa68c2;padding:10px 20px;border:none;cursor:pointer;}
...
function validateForm() {
	...
	if (subject == "" ) {
        alert("Введите тему вашего письма");
		$("#your_subject").focus();
        return false;
    } 
  ...
  <div class="8u">
    <section class="left-content">
     <h2><?php echo stripslashes($pageDetails["page_title"]); ?></h2>
      ...
      <div class="success">Ваше письмо было успешно отправлено. Ждите ответа в течении 2 часов. Спасибо!</div>
      <?php } if ($_GET["msg"] == "error") {  ?>
      <div class="error">Произошла ошибка! Пожалуйста, попробуйте познее.</div>
      <?php } ?>
      <form action="contact-us.php" method="post" name="f" onsubmit="return validateForm();">
        <div class="rows">
			<div class="label"><span style="color:#F00;">*</span>Ваше имя: </div>
        ...
        <div class="rows">
			<div class="label"><span style="color:#F00;">*</span>Тема: </div>
			<div class="input-row" ><input name="your_subject" id="your_subject" type="text" class="textbox" autocomplete="off"></div>
		</div>
        
         <div class="rows">
			<div class="label"><span style="color:#F00;">*</span>Сообщение: </div>
         ...
         <div class="rows">
         <div class="label"></div>
         <input type="submit" value="Отправить" name="sbtn" class="submit_button" />
         </div>
